...
function init(settings) {
	...
	options = {
		...
		dev: false,
		entry: {
			file: '/./_app/start-87b1fe4f.js',
			css: ['/./_app/assets/start-a8cd1609.css'],
			js: ['/./_app/start-87b1fe4f.js', '/./_app/chunks/vendor-33276b55.js']
		},
		fetched: void 0,
		floc: false,
...
var metadata_lookup = {
	'src/routes/__layout.svelte': {
		entry: '/./_app/pages/__layout.svelte-b5b57fb0.js',
		css: [],
		js: ['/./_app/pages/__layout.svelte-b5b57fb0.js', '/./_app/chunks/vendor-33276b55.js'],
		styles: null
	},
	'src/routes/__error.svelte': {
		entry: '/./_app/pages/__error.svelte-d777c606.js',
		css: [],
		js: ['/./_app/pages/__error.svelte-d777c606.js', '/./_app/chunks/vendor-33276b55.js'],
		styles: null
	},
	'src/routes/index.svelte': {
		entry: '/./_app/pages/index.svelte-bdd808ce.js',
		css: ['/./_app/assets/pages/index.svelte-bde7ca2e.css'],
		js: ['/./_app/pages/index.svelte-bdd808ce.js', '/./_app/chunks/vendor-33276b55.js'],
		styles: null
	},
	'src/routes/contact.svelte': {
		entry: '/./_app/pages/contact.svelte-a8981367.js',
		css: [],
		js: ['/./_app/pages/contact.svelte-a8981367.js', '/./_app/chunks/vendor-33276b55.js'],
		styles: null
	}
};
...
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `<header><nav><a href="${'.'}">Home</a>
		<a href="${'contact'}">Contact</a></nav></header>
<main>${slots.default ? slots.default({}) : ``}</main>
<footer><p>A project by <a aria-label="${'Open the Rodney Lab site'}" href="${'https://rodneylab.com/'}" rel="${'noopener'}">RODNEY LAB</a>.
	</p></footer>`;
});
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${
		(($$result.head += `${
			(($$result.title = `<title>svelte-backblaze</title>`), '')
		}<meta name="${'description'}" content="${'svelte-backblaze: app for testing svelte-kit with backblaze and netlify functions'}" data-svelte="svelte-xirtay">`),
		'')
	}
<h1>svelte-backblaze</h1>

<span><button class="${'svelte-2zk0if'}">Clicked ${escape2(count)}
		${escape2('times')}</button>
</span>`;
});

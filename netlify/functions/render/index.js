...
function init(settings) {
	...
	options = {
		...
		dev: false,
		entry: {
			file: '/./_app/start-1513b3d7.js',
			css: ['/./_app/assets/start-a8cd1609.css'],
			js: ['/./_app/start-1513b3d7.js', '/./_app/chunks/vendor-fa1618df.js']
		},
		fetched: void 0,
		floc: false,
...
var metadata_lookup = {
	'src/routes/__layout.svelte': {
		entry: '/./_app/pages/__layout.svelte-3653f6b0.js',
		css: [],
		js: ['/./_app/pages/__layout.svelte-3653f6b0.js', '/./_app/chunks/vendor-fa1618df.js'],
		styles: null
	},
	'src/routes/__error.svelte': {
		entry: '/./_app/pages/__error.svelte-257827b6.js',
		css: [],
		js: ['/./_app/pages/__error.svelte-257827b6.js', '/./_app/chunks/vendor-fa1618df.js'],
		styles: null
	},
	'src/routes/index.svelte': {
		entry: '/./_app/pages/index.svelte-cca1180d.js',
		css: [],
		js: ['/./_app/pages/index.svelte-cca1180d.js', '/./_app/chunks/vendor-fa1618df.js'],
		styles: null
	},
	'src/routes/contact.svelte': {
		entry: '/./_app/pages/contact.svelte-fef3dcda.js',
		css: [],
		js: ['/./_app/pages/contact.svelte-fef3dcda.js', '/./_app/chunks/vendor-fa1618df.js'],
		styles: null
	}
};
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${
		(($$result.head += `${(($$result.title = `<title>svelte-backblaze</title>`), '')}`), '')
	}
<h1>svelte-backblaze</h1>
<label><input type="${'file'}"></label>
<form method="${'post'}" enctype="${'multipart/form-data'}"><label><input type="${'file'}"></label></form>
<button>Clicked ${escape2(count)}
